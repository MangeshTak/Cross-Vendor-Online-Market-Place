...
<html lang="en">
  ...
  <div class="form">
    <form class="register-form" action="register.php?process" method = "POST" >
      ...
      <input type="text" placeholder="Home Phone" name="homePhone" required/>
    ...
    if(isset($_GET["process"])){
        ...
        if($password != $confirmPassword){
			...
			echo "<p>Invalid inputs for name.</p>";
		}else if(preg_match('/[a-z]/i', $homePhone) || preg_match('/[a-z]/i', $cellPhone)){
			echo "<p>Invalid inputs for phone numbers</p>";
		}else{
            //all gucci
